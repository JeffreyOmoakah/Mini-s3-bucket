...
// Open creates or reopens a store at the given directory and returns it
// through the ObjectStore interface.
func Open(dataDir string) (ObjectStore, error) {
	return openDiskStore(dataDir)
}

// openDiskStore creates or reopens a DiskStore at the given directory.
